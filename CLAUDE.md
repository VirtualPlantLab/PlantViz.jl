...
**PlantViz.jl** implements 3D visualization of meshes, light sources and bounding boxes
generated by other packages within the [VirtualPlantLab](https://virtualplantlab.com) (VPL)
ecosystem. It relies on Makie and its different backends to do so.
